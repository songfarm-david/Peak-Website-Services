				...
				<div class="row">
					<div class="col col-4">
						<section data-id="service-development" class="service-section">
							...
							<a href="/website-services/website-development-services.php" class="green-bg">Learn More</a>
						</section>
					</div>
					...
					<div class="col col-4">
						<section data-id="service-maintenance" class="service-section">
							...
							<a href="/website-services/website-maintenance-services.php" class="blue-bg">Learn More</a>
						</section>
					</div>
					...
					<div class="col col-4">
						<section data-id="service-optimization" class="service-section">
							...
							<a href="/website-services/website-optimization-services.php" class="purple-bg">Learn More</a>
						</section>
					</div>
				</div>
			</div>
