...
<?php require_once('../_includes/header.php') ?>
	...
	<main>
		...
		<!-- service -->
		<section class="bg-image" id="website-maintenance-service">
			...
			<article class="article">
				...
				<p class="article-sub-title">Keeping You Protected so your website can perform</p>
				<p>Monitoring your website regularly for threats and security standard service procedure.</p>
			</article>

			<article class="article">
				<h3>Safe &amp; Secure Web Hosting</h3>
				<p class="article-sub-title">Keeping You Reliably Online All Year Long</p>
				<p><a href="">Hosting your website on Canadian soil</a> protects your privacy, but hosting it on our state-of-the-art servers ensures your web pages are served reliably and instantly to your customers.</p>
				<p class="call-out"><a href="/website-services/website-hosting-services.php">learn more about our Hosting Services</a>.</p>
			</article>

			<!-- style-NOTE: this section is styled a little differently -->
			<section class="article">
				<h3>Unlimited Content Updates, Unlimited Technical Support</h3>
				<p class="article-sub-title">Working with Peak Website Services is like having your own personal IT guy</p>
				<p>We carry out updates and are your ongoing technical support when you have questions about your online success.</p>
				<p>Best of all, you have a single point-of-contact for all your online needs. This greatly simplifies the complexities of having an online business, and allows you to focus on running your business.</p>
			</section>

			<p>Let us help you take hold of your online success. <br><a href="/contact.php">Contact Us Today</a>.</p>

		</section><!--/ end of website-maintenance-service section -->
